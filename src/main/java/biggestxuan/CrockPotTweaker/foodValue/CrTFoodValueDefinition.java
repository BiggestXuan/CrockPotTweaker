...
@ZenRegister
@ZenCodeType.Name(CrockPotTweaker.PREFIX+"FoodDefinition")
public class CrTFoodValueDefinition implements IRecipeManager {
    ...
    public void addRecipe(String name, IIngredient item, CrTFoodValue values, boolean isTag){
        FoodValuesDefinition definition = new FoodValuesDefinition(CrockPotTweaker.rl(name),rl(item),values.get(),isTag);
